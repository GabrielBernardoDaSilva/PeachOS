...
// curent process that is running
struct process* current_process = 0x00;
// all process in the computer
...
int processes_map_binary(struct process* process)
{
    int res = 0;
...
{
    int res = 0;
    res = processes_map_binary(process);
    return res;
}
